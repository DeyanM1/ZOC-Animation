...
cFullRed = "FF0000"
cRedPinkLight = "#D71A43"
cRedPinkDark = "#C10E3A"
cRedPinkDarkLight = "#EB0D22"

print("Frame width:", config.frame_width)
print("Frame height:", config.frame_height)

class FirstScene(Scene):
    def construct(self):
        self.wait(0.5)
        
        title = Text("FC", font="Rockwell", color=cTitleDARK).scale(1.5) 
        title_ext = Text("Future Crafts", font="Rockwell", color=cTitleLIGHT).scale(1.5)
        ...
        title2 = Text("ZOC", font="Rockwell", color=cMainPink).scale(1.5) 
        title_underline1 = Underline(title2, color=cMainMix) 
        ...
        title2_ext = Text("v2", font="valorax", color=cMainBlue).scale(1.5) 
        ...
        title2_ext_underline1 = Underline(title2_ext, color=cMainBlue)
        ...
        title2_group_underline1 = Underline(title2_group, color=cMainPink)
        ...
        credits = Text("BDY", font="Rockwell", color=cRedPinkDark).scale(1)
        credits_ext = Text("By Deyan, Louis", font="Rockwell", color=cRedPinkDarkLight).scale(1) 
